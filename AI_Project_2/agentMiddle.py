...
class Rob_middle_layer(Environment):
    ...
    def steer(self,target_pos):
        print(Environment.turn_counter)
        if 0 > Environment.turn_counter > 0:
            if Environment.old_hit_now == 1 and Environment.hit_now == 0:
                Environment.the_last_turn = 0
                return "straight"
            elif Environment.old_hit_now == 1 and Environment.hit_now == 1:
                Environment.turn_counter = Environment.turn_counter - 1
                Environment.the_last_turn = -1
                return "left"
        elif Environment.turn_counter < -5 and Environment.hit_now != 1:
            Environment.turn_counter = Environment.turn_counter + 1
            Environment.the_last_turn = 1
            return "right"
        else:
            if self.percepts['whisker']:
                ...
                Environment.total_angle = goal_from_rob

                if Environment.total_angle > 45:
                    if goal_from_rob > self.straight_angle - 45:
                        Environment.turn_counter = Environment.turn_counter + 1
                        Environment.the_last_turn = 1
                        return "right"
                    elif goal_from_rob < -self.straight_angle - 45:
                        Environment.turn_counter = Environment.turn_counter - 1
                        Environment.the_last_turn = -1
                        return "left"
                    else:
                        Environment.the_last_turn = 0
                        return "straight"
                elif Environment.total_angle > 90:
                    if goal_from_rob > self.straight_angle - 90:
                        Environment.turn_counter = Environment.turn_counter + 1
                        Environment.the_last_turn = 1
                        return "right"
                    elif goal_from_rob < -self.straight_angle - 90:
                        Environment.turn_counter = Environment.turn_counter - 1
                        Environment.the_last_turn = -1
                        return "left"
                    else:
                        Environment.the_last_turn = 0
                        return "straight"
                elif Environment.total_angle > 135:
                    if goal_from_rob > self.straight_angle - 135:
                        Environment.turn_counter = Environment.turn_counter + 1
                        Environment.the_last_turn = 1
                        return "right"
                    elif goal_from_rob < -self.straight_angle - 135:
                        Environment.turn_counter = Environment.turn_counter - 1
                        Environment.the_last_turn = -1
                        return "left"
                    else:
